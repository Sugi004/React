...
<li className="nav-item">
    ...
    <div id="collapsePages" className="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div className="bg-white py-2 collapse-inner rounded">
            ...
            <a className="collapse-item" href="javascript(void)">Login</a>
            <a className="collapse-item" href="javascript(void)">Register</a>
            <a className="collapse-item" href="javascript(void)">Forgot Password</a>
            <div className="collapse-divider"></div>
            <h6 className="collapse-header">Other Pages:</h6>
            <a className="collapse-item" href="javascript(void)">404 Page</a>
            <a className="collapse-item" href="javascript(void)">Blank Page</a>
        </div>
    </div>
</li>
